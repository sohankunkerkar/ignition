...
type fileDir types.Directory

func (fd fileDir) node() types.Node {
	return types.Directory(fd).Node
}

func (fd fileDir) create(l *log.Logger, u util.Util) error {
	return nil
}
func TestEntrySort(t *testing.T) {
	...
	for i, test := range tests {
		...
		for j := range dirs {
			entries = append(entries, fileDir(test.in.data[j]))
		}
